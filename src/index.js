...
console.clear();
console.log(chalk.blue(chalk.bold(`Systemmm`)), (chalk.white(`>>`)), (chalk.green(`Starting up`)), (chalk.white(`...`)))
console.log(`\u001b[0m`)
console.log(chalk.red(` ➡️  © godcraft | 2022⬅️`))
console.log(chalk.red(`copyright`))
console.log(`\u001b[0m`)
console.log(`\u001b[0m`)
console.log(chalk.blue(chalk.bold(`Systemmm`)), (chalk.white(`>>`)), chalk.red(`Version ${require(`${process.cwd()}/package.json`).version}`), (chalk.green(`loaded`)))
console.log(`\u001b[0m`);
...
manager.on('shardCreate', shard => {
  ...
  console.log(chalk.blue(chalk.bold(`Systemmm`)), (chalk.white(`>>`)), (chalk.green(`Starting`)), chalk.red(`Shard #${shard.id + 1}`), (chalk.white(`...`)))
  console.log(`\u001b[0m`);

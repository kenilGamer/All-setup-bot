...
module.exports = (client) => {
    ...
    if (client.shard.ids[0] === 0) console.log(chalk.blue(chalk.bold(`Systemmm`)), (chalk.white(`>>`)), (chalk.green(`Loading commands`)), (chalk.white(`...`)))
    ...
    fs.readdirSync('./src/interactions').forEach(dirs => {
        ...
        if (client.shard.ids[0] === 0) console.log(chalk.blue(chalk.bold(`Systemmm`)), (chalk.white(`>>`)), chalk.red(`${commandFiles.length}`), (chalk.green(`commands of`)), chalk.red(`${dirs}`), (chalk.green(`loaded`)));
